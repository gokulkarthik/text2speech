cp exp_dir/best_model.pth output/store/ta/aligntts/
cp exp_dir/config.json output/store/ta/aligntts/
...
python3 -m TTS.bin.synthesize --text "../../datasets/indictts/ta/metadata_test_male.csv" \
    --model_path output/store/ta/aligntts/best_model.pth \
    --config_path output/store/ta/aligntts/config.json \
    ...
    --out_path output_wavs/ta_male_aligntts_hifi 

# python3 scripts/evaluate_mcd.py \
#     output_wavs/ta_male_aligntts_hifi/ \
