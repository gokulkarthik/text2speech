cp output/ta_glowtts_indictts_male-June-30-2022_10+21AM-d4b542f/best_model.pth output/store/ta/glowtts/
cp output/ta_glowtts_indictts_male-June-30-2022_10+21AM-d4b542f/config.json output/store/ta/glowtts/
...
python3 -m TTS.bin.synthesize --text "../../datasets/indictts/ta/metadata_test_male.csv" \
    ...
    --out_path output_wavs/ta_glowtts_male_hifi
