...
python3 -m TTS.bin.synthesize --text "../../datasets/googletts/ta/processed/metadata_test_zero_shot.csv" \
    ...
    --encoder_path output_speaker_encoder/major-lake-8-epoch=19.ckpt \
    --out_path output_wavs/ta_googletts_fastpitch_hifi_0shot
