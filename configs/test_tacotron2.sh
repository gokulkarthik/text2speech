cp exp_dir/best_model.pth output/store/ta/tacotron2/
cp exp_dir/config.json output/store/ta/tacotron2/
...
python3 -m TTS.bin.synthesize --text "../../datasets/indictts/ta/metadata_test_male.csv" \
    --model_path output/store/ta/tacotron2/best_model.pth \
    --config_path output/store/ta/tacotron2/config.json \
    ...
    --out_path output_wavs/ta_male_tacotron2_hifi 

# python3 scripts/evaluate_mcd.py \
#     output_wavs/ta_male_tacotron2_hifi/ \
